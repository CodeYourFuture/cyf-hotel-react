    ...
    <div className="row p-3">
      <div className="card bg-dark text-white col">
        ...
        <div className="card-body">
          ...
          <a href="https://visitlondon.com" className="btn btn-outline-light btn-info btn-lg mt-5">
            Visit London
          </a>
        </div>
      </div>
      ...
      <div className="card bg-dark text-white col">
        ...
        <div className="card-body">
          ...
          <a href="https://www.visitmanchester.com" className="btn btn-outline-light btn-info btn-lg mt-5">
            Visit Manchester
          </a>
        </div>
      </div>
      ...
      <div className="card bg-dark text-white col">
        ...
        <div className="card-body">
          ...
          <a href="http://www.peoplemakeglasgow.com" className="btn btn-outline-light btn-info btn-lg mt-4">
            Visit Glasgow
          </a>
        </div>
      </div>
