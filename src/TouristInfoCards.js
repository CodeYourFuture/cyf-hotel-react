  ...
  return (
    <div className="cards">
      <CardCity
        ...
        CityName="Glasgow"
        Summary="Glasgow is the largest city in scotland, it has lot to offer visiting tourists."
      />
      <CardCity
      ...
      <CardCity
        ...
        CityName="London"
        Summary="London is the capital of United Kingdom of Great Britain and North Ireland.london is multicultural, bustling and vibrant "
      />
    </div>
  );
};
