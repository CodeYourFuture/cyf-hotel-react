...
function TouristInfoCards(){
    ...
    <div className = "cards">
    <div className="card">
	    <img src="https://www.inspiringtravelscotland.com/wp-content/uploads/2019/07/Glasgow-river-clyde-landscape-night.png" className="card-img-top" alt="glasgow"/>
    ...
    <div className="card">
	    <img src="https://images.pexels.com/photos/5212814/pexels-photo-5212814.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" className="card-img-top" alt="manchester"/>
	    <div className="card-body">
            <h2>Manchester</h2>
    ...
    <div className="card">
	    <img src="https://images.pexels.com/photos/726484/pexels-photo-726484.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" className="card-img-top" alt="London"/>
	    <div className="card-body">
            <h2>London</h2>
