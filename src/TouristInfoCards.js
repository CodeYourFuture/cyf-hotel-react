        ...
        <div className="col">
          <div className="card shadow">
            ...
            <div className="card-body">
              ...
              <p className="card-title">
                Manchester is a m one of the most fun cities located in the
                Northwest of England. Warm and welcoming, this great city has a
                dynamic history in politic, football, music and sport Industry.
                With a combined heritage and and jam packed eccentric
                surroundings such as restaurants, bars,
              </p>
              <a
