(function (global, factory) {
  ...
  var beat = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '50%': {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _emotion.css)([], [_this.props.color, _this.props.size, _this.props.size, _this.props.margin, beat, i % 2 ? '0s' : '0.35s'], function createEmotionStyledRules(x0, x1, x2, x3, x4, x5) {
          return [{
            '': {
              ...
              'margin': x3,
              'borderRadius': '100%',
              'WebkitAnimation': x4 + ' 0.7s ' + x5 + ' infinite linear',
              'animation': x4 + ' 0.7s ' + x5 + ' infinite linear',
