(function (global, factory) {
  ...
  var grid = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '0%': {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (rand) {
        return (0, _emotion.css)([], [_this.props.color, _this.props.size, _this.props.size, _this.props.margin, grid, rand / 100 + 0.6, rand / 100 - 0.2], function createEmotionStyledRules(x0, x1, x2, x3, x4, x5, x6) {
          return [{
            '': {
              ...
              'WebkitAnimation': x4 + ' ' + x5 + 's ' + x6 + 's infinite ease',
              'animation': x4 + ' ' + x5 + 's ' + x6 + 's infinite ease'
            }
          }];
        });
      }, _this.wrapper = function () {
        return (0, _emotion.css)([], [parseFloat(_this.props.size) * 3 + parseFloat(_this.props.margin) * 6], function createEmotionStyledRules(x0) {
          return [{
            '': {
              'width': x0 + 'px',
              'fontSize': '0'
