(function (global, factory) {
  ...
  var pulse = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '0%': {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _emotion.css)([], [_this.props.color, _this.props.size, _this.props.size, _this.props.margin, pulse, i * 0.12], function createEmotionStyledRules(x0, x1, x2, x3, x4, x5) {
          return [{
            '': {
              'backgroundColor': x0,
              'width': x1 + 'px',
              ...
              'WebkitAnimation': x4 + ' 0.75s ' + x5 + 's infinite cubic-bezier(.2,.68,.18,1.08)',
              'animation': x4 + ' 0.75s ' + x5 + 's infinite cubic-bezier(.2,.68,.18,1.08)',
