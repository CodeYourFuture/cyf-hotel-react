(function (global, factory) {
  ...
  var bounce = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '0%, 100%': {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _emotion.css)([], [i % 2 ? '0' : 'auto', i % 2 ? 'auto' : '0', _this.props.size / 2, _this.props.size / 2, _this.props.color, bounce, i === 2 ? '-1s' : '0s'], function createEmotionStyledRules(x0, x1, x2, x3, x4, x5, x6) {
          return [{
            '': {
              'position': 'absolute',
              'top': x0,
              ...
              'WebkitAnimation': x5 + ' 2s ' + x6 + ' infinite linear',
              'animation': x5 + ' 2s ' + x6 + ' infinite linear'
            }
          }];
        });
      }, _this.wrapper = function () {
        return (0, _emotion.css)([], [_this.props.size, _this.props.size, rotate], function createEmotionStyledRules(x0, x1, x2) {
          return [{
            '': {
              'position': 'relative',
              'width': x0 + 'px',
              ...
              'WebkitAnimationFillMode': 'forwards',
              'animationFillMode': 'forwards',
              'WebkitAnimation': x2 + ' 2s 0s infinite linear',
              'animation': x2 + ' 2s 0s infinite linear'
            }
          }];
        });
