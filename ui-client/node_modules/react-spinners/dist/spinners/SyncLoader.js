(function (global, factory) {
  ...
  var sync = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '33%': {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _emotion.css)([], [_this.props.color, _this.props.size, _this.props.size, _this.props.margin, sync, i * 0.07], function createEmotionStyledRules(x0, x1, x2, x3, x4, x5) {
          return [{
            '': {
              'backgroundColor': x0,
              'width': x1 + 'px',
              ...
              'WebkitAnimation': x4 + ' 0.6s ' + x5 + 's infinite ease-in-out',
              'animation': x4 + ' 0.6s ' + x5 + 's infinite ease-in-out',
