(function (global, factory) {
  ...
  var clip = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '0%': {
      ...
      '50%': {
        'WebkitTransform': 'rotate(180deg) scale(0.8)',
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function () {
        return (0, _emotion.css)([], [_this.props.size, _this.props.size, _this.props.color, clip], function createEmotionStyledRules(x0, x1, x2, x3) {
          return [{
            '': {
              ...
              'WebkitAnimation': x3 + ' 0.75s 0s infinite linear',
              'animation': x3 + ' 0.75s 0s infinite linear',
