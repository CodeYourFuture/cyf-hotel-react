(function (global, factory) {
  ...
  var even = (0, _emotion.keyframes)([], [riseAmount, riseAmount], function createEmotionStyledRules(x0, x1) {
    return [{
      '0%': {
      ...
      '75%': {
        'WebkitTransform': 'translateY(' + x1 + 'px)',
        'transform': 'translateY(' + x1 + 'px)'
      },
      '100%': {
        'WebkitTransform': 'translateY(0) scale(1.0)',
        'transform': 'translateY(0) scale(1.0)'
      }
    }];
  });

  var odd = (0, _emotion.keyframes)([], [riseAmount, -riseAmount], function createEmotionStyledRules(x0, x1) {
    return [{
      '0%': {
        'WebkitTransform': 'scale(0.4)',
        'transform': 'scale(0.4)'
      ...
      '100%': {
        'WebkitTransform': 'translateY(0) scale(0.75)',
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _emotion.css)([], [_this.props.color, _this.props.size, _this.props.size, _this.props.margin, i % 2 === 0 ? even : odd], function createEmotionStyledRules(x0, x1, x2, x3, x4) {
          return [{
            '': {
              'backgroundColor': x0,
              'width': x1 + 'px',
              ...
              'WebkitAnimation': x4 + ' 1s 0s infinite cubic-bezier(.15,.46,.9,.6)',
              'animation': x4 + ' 1s 0s infinite cubic-bezier(.15,.46,.9,.6)',
