(function (global, factory) {
  ...
  var square = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '25%': {
        'WebkitTransform': 'rotateX(180deg) rotateY(0)',
        'transform': 'rotateX(180deg) rotateY(0)'
      },
      '50%': {
        'WebkitTransform': 'rotateX(180deg) rotateY(180deg)',
        'transform': 'rotateX(180deg) rotateY(180deg)'
      },
      '75%': {
        'WebkitTransform': 'rotateX(0) rotateY(180deg)',
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function () {
        return (0, _emotion.css)([], [_this.props.color, _this.props.size, _this.props.size, square], function createEmotionStyledRules(x0, x1, x2, x3) {
          return [{
            '': {
              'backgroundColor': x0,
              'width': x1 + 'px',
              ...
              'WebkitAnimation': x3 + ' 3s 0s infinite cubic-bezier(.09,.57,.49,.9)',
              'animation': x3 + ' 3s 0s infinite cubic-bezier(.09,.57,.49,.9)',
