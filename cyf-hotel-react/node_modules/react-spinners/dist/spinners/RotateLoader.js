(function (global, factory) {
  ...
  var rotate = (0, _emotion.keyframes)([], [], function createEmotionStyledRules() {
    return [{
      '0%': {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _emotion.css)([], [i % 2 ? -28 : 25], function createEmotionStyledRules(x0) {
          return [{
            '': {
              'opacity': '0.8',
              'position': 'absolute',
        ...
        return (0, _emotion.css)([], [_this.props.color, _this.props.size, _this.props.size, _this.props.margin], function createEmotionStyledRules(x0, x1, x2, x3) {
          return [{
            '': {
              'backgroundColor': x0,
              'width': x1 + 'px',
        ...
        return (0, _emotion.css)([_this.ball()], [rotate], function createEmotionStyledRules(x0) {
          return [{
            'display': 'inline-block',
            'position': 'relative',
            'WebkitAnimationFillMode': 'both',
            'animationFillMode': 'both',
            'WebkitAnimation': x0 + ' 1s 0s infinite cubic-bezier(.7,-.13,.22,.86)',
            'animation': x0 + ' 1s 0s infinite cubic-bezier(.7,-.13,.22,.86)'
          }];
        });
      }, _this.long = function () {
        return (0, _emotion.css)([_this.ball(), _this.style(1)], [], function createEmotionStyledRules() {
          return [{}];
        });
      }, _this.short = function () {
        return (0, _emotion.css)([_this.ball(), _this.style(2)], [], function createEmotionStyledRules() {
          return [{}];
        });
